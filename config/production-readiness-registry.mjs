...
export const PR_RECOVERY_DISPOSITIONS = Object.freeze([
  { number: 409, status: "closed", disposition: "close", owner: "admin-os", replacementPr: 546, reason: "The stale branch was closed without replay. Bounded Ecosystem Truth recovery merged in PR #546; realtor and car-sales remain active closed-beta surfaces." },
  ...
  { number: 316, status: "closed", disposition: "close", owner: "public-profiles", replacementPr: 547, reason: "The stale branch was closed without replay. Profile-specific install-identity recovery merged in PR #547." },
  { number: 305, status: "closed", disposition: "close", owner: "public-profiles", replacementPr: 548, reason: "The stale branch was closed without replay. Dean identity, Direct Connect, and profile-owned booking recovery merged in PR #548; stale regulated claims were not carried forward." },
  ...
  { number: 223, status: "closed", disposition: "close", owner: "release-control", reason: "The alternate lockfile and historical evidence are obsolete in the npm-authoritative repository." },
  ...
  { number: 219, status: "closed", disposition: "close", owner: "public-profiles", replacementPr: 549, reason: "The stale branch was closed without replay. Canonical profile-authority recovery merged in PR #549." },
  { number: 218, status: "closed", disposition: "close", owner: "release-control", reason: "Only package-lock.json is authoritative for this npm repository." },
  { number: 215, status: "closed", disposition: "close", owner: "direct-connect", replacementPr: 545, reason: "The stale 99-file branch was closed without replay. Bounded operations-queue and replay-safe-create recovery merged in PR #545; later email/operator work remains separately scoped." },
  { number: 214, status: "closed", disposition: "close", owner: "exchange", replacementPr: 550, reason: "The stale branch was closed without replay. Request-only profile-catalog and About-action recovery merged in PR #550; obsolete inventory and oversized registry changes were not carried forward." },
  { number: 213, status: "closed", disposition: "close", owner: "discovery", replacementPr: 551, reason: "The stale branch was closed without replay. Shared landing, recent-page, private-shell, and sitemap recovery merged in PR #551; outdated crawl evidence was not carried forward." },
  ...
  { number: 545, status: "closed", disposition: "close", owner: "direct-connect", headRef: "release-0/direct-connect-ops-recovery", mergedIntoMain: true, mergeCommit: "d0214987d1c61b3cf820cdcef4b36840a976c51a", replaces: [215], reason: "Merged September 4, 2026. This records source integration; runtime and later email/operator behavior require their own proof." },
  { number: 546, status: "closed", disposition: "close", owner: "admin-os", headRef: "release-0/admin-ecosystem-truth", mergedIntoMain: true, mergeCommit: "904bedcc8cdcf83c9251e36031f0c794d7badc72", replaces: [409], reason: "Merged September 4, 2026. Source integration does not establish live acceptance of every admin operation." },
  { number: 547, status: "closed", disposition: "close", owner: "public-profiles", headRef: "release-0/profile-app-identity", mergedIntoMain: true, mergeCommit: "50637ef2bfe190b0870ac8b7decb72f1fd84828c", replaces: [316], reason: "Merged September 4, 2026. Source integration is distinct from deployment and device installation proof." },
  { number: 548, status: "closed", disposition: "close", owner: "public-profiles", headRef: "release-0/dean-profile-recovery", mergedIntoMain: true, mergeCommit: "4a768ca6174c123bf48de61698728d2e7516bcc1", replaces: [305], reason: "Merged September 4, 2026. Source integration is distinct from live booking and external-provider proof." },
  { number: 549, status: "closed", disposition: "close", owner: "public-profiles", headRef: "release-0/public-profile-authority-recovery", mergedIntoMain: true, mergeCommit: "612d7af168ceabe1e05446c611ac65f9308add9c", replaces: [219], reason: "Merged September 4, 2026. Source integration does not establish every production profile's current data or authority." },
  { number: 550, status: "closed", disposition: "close", owner: "exchange", headRef: "release-0/exchange-profile-catalog-recovery", mergedIntoMain: true, mergeCommit: "a56f56ccc50d84df2b33fad6c2f4aae24e358ba7", replaces: [214], reason: "Merged September 4, 2026. Source integration is distinct from live Exchange customer-flow proof." },
  { number: 551, status: "closed", disposition: "close", owner: "discovery", headRef: "release-0/discovery-indexability-recovery", mergedIntoMain: true, mergeCommit: "42aca2d59c26b1173af339924ff3dfe8843da8a4", replaces: [213], reason: "Merged September 4, 2026. Source integration does not establish current search-engine indexing or crawl freshness." },
]);
