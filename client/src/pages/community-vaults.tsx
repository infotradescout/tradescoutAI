        ...
        <div className="bg-white border-b shadow-sm">
          <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-6 p-8">
            ...
            <div className="space-y-1">
              ...
              <p className="text-3xl font-bold text-gray-900">{stats.totalVaults}</p>
            </div>
            <div className="space-y-1">
              <p className="text-sm text-gray-600 flex items-center space-x-1">
              ...
              <p className="text-3xl font-bold text-gray-900">{formatCurrency(stats.avgBalance)}</p>
            </div>
            <div className="space-y-1">
              <p className="text-sm text-gray-600">Top Vault</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="mb-6">
              ...
              <p className="text-gray-600 mt-1">Community funds managed transparently</p>
            </div>

            {vaults.length === 0 ? (
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-8 text-center">
                <AlertCircle className="w-8 h-8 text-blue-500 mx-auto mb-3" />
                <p className="text-gray-700 font-medium">No community vaults yet</p>
          ...
          {selectedVaultData && (
            <div className="lg:col-span-1">
              <div className="bg-white rounded-lg shadow-lg p-6 sticky top-4">
                <h3 className="text-xl font-bold text-gray-900 mb-4">Vault Details</h3>
