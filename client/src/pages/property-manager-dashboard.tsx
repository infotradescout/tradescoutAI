...
export default function PropertyManagerDashboard() {
  ...
  const getPriorityColor = (priority: MaintenanceRequest["priority"]) => {
    switch (priority) {
      ...
      case "high":
        return "text-ts-orange bg-ts-orange/10";
      case "medium":
        return "text-yellow-600 bg-yellow-100";
      case "low":
        return "text-green-600 bg-green-100";
      default:
        return "text-white/60 bg-tsCard";
    }
  };
              ...
              <CardContent>
                <div className="space-y-4">
                  {mockProperties.map((property) => (
                    <div
                      key={property.id}
                      className="p-4 bg-tsCard rounded-lg border border-white/10"
                    >
                      <div className="flex items-center justify-between mb-3">
                        <div className="flex items-center space-x-3">
                          <div
                            className={`w-3 h-3 rounded-full ${getStatusColor(property.status)}`}
                          ></div>
                      ...
                      <div className="grid grid-cols-4 gap-4 text-sm">
                        ...
                        <div>
                          ...
                          <p className="text-white">
                            {new Date(property.nextMaintenanceDate).toLocaleDateString()}
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-center justify-between mb-3">
                        <div className="flex items-center space-x-3">
                          <h3 className="font-semibold text-white">
                            {request.propertyAddress} - {request.unit}
                          </h3>
