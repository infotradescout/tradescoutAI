...
type MockDirectConnectProps = {
  ...
  initialStoneSelections?: ReadonlyArray<{ itemId: string; stoneName: string }> | null;
};
    ...
    expect(wishlistContactProps.initialStoneSelections).toEqual([
      {
        ...
        stoneName: expect.any(String),
      },
    ]);
    expect(wishlistContactProps.initialStoneSelections[0].stoneName).not.toMatch(
