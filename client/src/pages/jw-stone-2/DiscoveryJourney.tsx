  ...
  return (
    <section className="jw2-discovery" aria-labelledby="jw2-discovery-title">
      <div className="jw2-discovery-intro">
        ...
        <p>
          Choose how you work, then open the full current collection or start with a color
          direction. Every current selection stays reachable.
        </p>
      </div>
          ...
          <div className="jw2-color-choices" aria-label="Choose a color direction">
            {colorChoices.map((choice) => (
              <button
                ...
                key={choice.id}
                data-color-direction={choice.id}
