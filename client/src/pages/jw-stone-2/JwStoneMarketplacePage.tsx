  ...
  const colorChoices = useMemo(
    () =>
      JW_STONE_2_COLOR_DIRECTION_OPTIONS.map((option) => ({
        ...
        count:
          option.id === "all"
            ? JW_STONE_2_INVENTORY.length
            : JW_STONE_2_INVENTORY.filter((item) => item.colorDirection === option.id).length,
      })),
    []
  );
      ...
      <main>
        <section className="jw2-hero">
          ...
          <div className="jw2-hero-content">
            ...
            <a href="#first-cut">See First Cut</a>
          </div>
        </section>
