...
describe("DefaultProfileTheme", () => {
  ...
  it("renders Cameron as a complete first-deliverable profile with service-specific Direct Connect", () => {
    act(() => {
      root.render(
        <DefaultProfileTheme
          ...
          heroTitle="A better view."
          heroText="Drone photo and video."
          logoUrl="/images/profiles/precision-aerial/logo.jpg"
          heroImageUrl="/images/profiles/precision-aerial/real-estate-aerial-01.jpg"
          heroImageAlt="Aerial property view"
          ...
          galleryItems={[
            {
              ...
              imageAlt: "Wide property view",
            },
            {
              slug: "close",
              title: "Closer property view",
              imageUrl: "/images/profiles/precision-aerial/real-estate-aerial-02.jpg",
              imageAlt: "Closer property view",
            },
          ]}
          socials={[
            {
              label: "Instagram",
              handle: "@PrecisionAerialService",
              href: "https://www.instagram.com/precisionaerialservice/",
              kind: "instagram",
            },
            {
              label: "TikTok",
              handle: "@chillshots",
              href: "https://www.tiktok.com/@chillshots",
              kind: "tiktok",
            },
          ]}
    ...
    act(() => {
      container
        .querySelector<HTMLButtonElement>('[data-testid="default-profile-service-2"]')
        ?.click();
    });
  ...
  it("changes palette, content, media, and enabled sections using props only", () => {
    act(() => {
      root.render(
        <DefaultProfileTheme
          businessName="Solstice Kitchen"
          categoryLabel="Restaurant"
          locationLabel="Austin, Texas"
          heroTitle="Dinner starts here."
          heroImageUrl="/restaurant/hero.jpg"
          brandColors={{
            primary: "#dc2626",
            secondary: "#f59e0b",
            background: "#1c1917",
          ...
          services={["Dinner", "Private events"]}
          serviceAreas={[]}
          galleryItems={[]}
          aboutText="A neighborhood kitchen."
          badges={["Restaurant", "Private dining"]}
          stats={[{ label: "Services", value: "2" }]}
    ...
    expect(container.textContent).toContain("Solstice Kitchen");
  ...
  it("keeps service areas independent, drops empty detail shells, and rejects broken hero media", () => {
    act(() => {
      root.render(
        <DefaultProfileTheme
          businessName="Harbor Workshop"
          heroTitle="Made locally."
          heroImageUrl="https://images.example.com/broken.jpg"
          services={[]}
          serviceAreas={["Mobile County"]}
          galleryItems={[]}
          showAbout={false}
          showServiceAreas
          showContact={false}
    ...
    const heroImage = container.querySelector<HTMLImageElement>(
      'img[src="https://images.example.com/broken.jpg"]'
    );
        ...
        <DefaultProfileTheme
          ...
          recommendations={[
            ...
            },
            {
              ...
              comment: "Do not promote this as praise.",
              projectType: null,
          ...
          recommendations={[
            {
              ...
              projectType: null,
              customerName: "",
              subjectName: "Example Provider",
              subjectHref: "/u/example-provider",
            },
          ]}
