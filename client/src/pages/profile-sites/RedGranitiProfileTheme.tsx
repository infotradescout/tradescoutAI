...
export default function RedGranitiProfileTheme({
  ...
  return (
    <div
      className="min-h-screen overflow-x-clip bg-[var(--red-paper)] text-[var(--red-ink)]"
      style={pageStyle}
    ...
    >
      ...
      >
        <div className="mx-auto flex min-h-20 max-w-[1560px] items-center gap-4 px-4 sm:px-7 lg:px-10">
          <a
            href="#top"
      ...
      <main id="top">
        <section className="relative isolate overflow-hidden bg-[var(--red-ink)] text-white">
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(90deg, rgba(16,12,12,0.98) 0%, rgba(20,15,15,0.88) 44%, rgba(20,15,15,0.48) 72%, rgba(20,15,15,0.76) 100%), linear-gradient(0deg, rgba(16,12,12,0.98) 0%, rgba(16,12,12,0.12) 55%, rgba(16,12,12,0.58) 100%)",
            }}
          />
          <div
            aria-hidden="true"
            ...
            <aside className="rounded-[2rem] border border-white/20 bg-black/30 p-6 shadow-2xl shadow-black/30 backdrop-blur-xl sm:p-8">
              ...
              <div className="mt-8 space-y-4 border-t border-white/15 pt-6 text-sm text-white/75">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <span>
                    <strong className="block text-white">Company-source information</strong>
                    <span className="mt-1 block leading-6">
                      Company facts and imagery are tied to R.E.D. Graniti's official sources.
                    </span>
                  </span>
                </div>
              </div>
          ...
          <div className="mx-auto max-w-[1480px]">
            <div className="grid gap-12 lg:grid-cols-[minmax(0,1.4fr)_minmax(320px,0.6fr)] lg:gap-20">
              ...
              <div className="rounded-[2rem] border border-black/10 bg-white p-7 shadow-[0_24px_70px_rgba(23,19,19,0.08)] sm:p-9">
                ...
                <p className="mt-6 text-sm font-black uppercase tracking-[0.16em] text-black/45">
                  R.E.D. Graniti company profile
                </p>
              </div>
            </div>
        ...
        <section id="quarries" className="bg-white px-5 py-20 sm:px-8 lg:px-12 lg:py-28">
          <div className="mx-auto max-w-[1480px]">
            <div className="grid gap-10 lg:grid-cols-[minmax(0,0.8fr)_minmax(0,1.2fr)] lg:items-end">
              <div>
                ...
                <h2 className="mt-4 text-4xl font-black leading-[1.03] tracking-[-0.045em] sm:text-5xl">
                  Company-owned sources across nine countries.
                </h2>
              </div>
              <div>
            ...
            <div className="mt-10 flex justify-center">
              ...
              >
                Open the official quarry directory
                <ArrowUpRight className="h-4 w-4" aria-hidden="true" />
              </a>
            </div>
          </div>
            ...
            <div className="grid lg:grid-cols-[minmax(0,0.72fr)_minmax(0,1.28fr)]">
              ...
              <div className="p-7 sm:p-10 lg:p-14">
                ...
                <div className="mt-8 grid gap-3 sm:grid-cols-3">
                  {[
                    ["Source company", identity.brandName],
                    ["First cut", JW_STONE_PUBLIC_IDENTITY.brandName],
                    ["Next step", "Start a Request"],
                  ].map(([label, value]) => (
                    <div key={label} className="rounded-2xl border border-black/10 bg-[var(--red-paper)] p-4">
                      <p className="text-[10px] font-black uppercase tracking-[0.15em] text-black/40">
                        {label}
                      </p>
        ...
        <section className="bg-white px-5 py-20 sm:px-8 lg:px-12 lg:py-24">
          <div className="mx-auto grid max-w-[1480px] gap-8 lg:grid-cols-[minmax(0,0.82fr)_minmax(0,1.18fr)]">
            <div>
              <p className="text-xs font-black uppercase tracking-[0.2em] text-[var(--red-mark)]">
                Company profile
              </p>
            ...
            <div className="rounded-[2rem] border border-black/10 bg-[var(--red-paper)] p-6 sm:p-8">
              {trustActions}
            </div>
          </div>
        </section>
      ...
      <a
        href={homeHref}
        className="sr-only focus:not-sr-only focus:fixed focus:bottom-4 focus:left-4 focus:z-[100] focus:rounded-md focus:bg-black focus:px-4 focus:py-3 focus:text-white"
      >
