      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-2xl mx-auto">
          <Link href="/contractors">
            <Button className="w-full bg-orange-500 hover:bg-orange-600">Find Contractors</Button>
          </Link>
          <Link href="/quote">
            <Button
              variant="outline"
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <Card className="bg-green-900/20 border-green-500/50">
          <CardContent className="p-12 text-center">
            ...
            <p className="text-gray-300 mb-8">
              Your FREE contractor Growth Pack is ready. We've also sent a download link to your
              email.
            </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                {!isHomeowner && (
                  <Link href="/contractors/apply">
                    <Button
                      variant="outline"
                      className="w-full border-orange-500 text-orange-500 hover:bg-orange-500 hover:text-white h-16"
                    >
                      <div className="text-center">
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="text-center mb-12">
        ...
        <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">Contractor Growth Pack</h1>
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300 text-sm">
                      Proven email and social media templates that connect with prospects and build
                      relationships
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300 text-sm">
                      How to price your services competitively while maximizing profit margins
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300 text-sm">
                      Turn one-time customers into repeat clients and referral sources
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300 text-sm">
                      Step-by-step guide to building your online presence and attracting customers
                    </p>
                  </div>
                </div>
              </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                      ...
                      <div>
                        <Input
                          ...
                          onChange={(e) =>
                            setFormData((prev) => ({ ...prev, serviceAreas: e.target.value }))
                          }
                          className="form-field"
                        />
                      </div>
                      ...
                      <div className="flex items-start space-x-2">
                        ...
                        <label htmlFor="consent" className="text-xs text-gray-400 cursor-pointer">
                          I agree to receive occasional emails with contractor tips and business
                          growth opportunities. You can unsubscribe at any time.
                        </label>
                      </div>
      ...
      <Card className="bg-gradient-to-r from-orange-500/20 to-orange-600/20 border-orange-500/30">
        <CardContent className="p-8 text-center">
          <h3 className="text-2xl font-bold text-white mb-4">
            Ready to start getting connections?
          </h3>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            {!isHomeowner && (
              <Link href="/contractors/apply">
                <Button
                  variant="outline"
                  className="border-orange-500 text-orange-500 hover:bg-orange-500 hover:text-white px-8 py-3 rounded-lg font-semibold transition-all duration-300"
                >
