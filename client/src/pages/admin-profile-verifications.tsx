  ...
  return (
    <AdminWorkspace data-testid="admin-business-verifications-v2">
      <AdminSection
        ...
        description="Review required business evidence and manual profile-account review requests. Approval controls protected business features; it does not publish the business profile."
        className="pt-0"
        actions={
          <Button
            type="button"
