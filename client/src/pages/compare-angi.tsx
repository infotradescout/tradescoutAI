  ...
  const faqs = [
    {
      ...
      answer:
        "Angi uses a lead-sales model where contractors pay per request. TradeScout uses trust-based matching where contractors pay only on completed work. This fundamentally changes incentives: Angi maximizes lead volume; TradeScout maximizes match quality.",
    },
    {
            ...
            <div className="space-y-6">
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-6 rounded-lg">
                <h3 className="text-xl font-semibold mb-3 text-red-600 dark:text-red-400">
                  Angi's Incentive Misalignment
                </h3>
                <ul className="space-y-2 text-tsTextSecondary">
                  <li className="flex items-start gap-2">
                    <AlertTriangle className="h-5 w-5 text-red-500 shrink-0 mt-0.5" />
                    <span>
                      <strong>Lead volume over quality:</strong> Selling 20 leads at $20 each ($400)
                      is better than 1 perfect match ($20). Incentive is to maximize leads sold, not
                      matches made.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
