        ...
        <Card>
          ...
          <CardContent className="prose max-w-none dark:prose-invert">
            ...
            <section className="mb-8">
              ...
              <p className="mb-4">
                A potential winner may be required to confirm eligibility, provide a mailing address,
                and complete any required tax or eligibility documentation. If a potential winner
                cannot be contacted, is ineligible, does not respond in a reasonable time, or declines
                the prize, TradeScout may select an alternate winner.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="mb-4">
                ...
                these Official Rules, acts fraudulently or disruptively, or attempts to undermine the
                lawful operation of the giveaway. TradeScout may cancel, suspend, or modify the
            ...
            <section className="mb-8">
              <h2 className="mb-4 text-2xl font-semibold">8. Release and Limitation of Liability</h2>
              <p className="mb-4">
