        ...
        <Card className="border-2 border-emerald-200">
          <CardHeader className="flex items-start justify-between">
            <div>
              ...
              <CardDescription>Your payment was received and the contribution is recorded.</CardDescription>
            </div>
          ...
          <CardContent className="space-y-4">
              ...
              <>
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <p className="font-semibold">${contribution.actualValue || contribution.estimatedValue}</p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-500">Verification</p>
                    <p className="font-semibold">{contribution.verifiedAt ? 'Verified' : 'Pending audit'}</p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-500">Vault Impact</p>
                    <p className="font-semibold">${contribution.actualValue || contribution.estimatedValue} added</p>
                  </div>
                </div>
              </>
            ) : (
            ...
            <div className="flex flex-wrap gap-3 pt-4">
              ...
              {contribution && (
                <Button variant="outline" onClick={() => navigate(`/community-builder/contributions/${contribution.id}`)}>
                  View details
                </Button>
              )}
