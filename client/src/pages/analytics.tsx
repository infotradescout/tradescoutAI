                ...
                <CardContent>
                  <div className="space-y-4">
                    {revenueTrendLoading && !revenueTrend ? (
                      ...
                      <p className="text-gray-400 text-sm">No revenue trend data available yet.</p>
                    ) : (
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                  {funnelLoading && !funnel ? (
                    Array.from({ length: 3 }).map((_, index) => (
                      <div
                        key={index}
                        className="p-4 bg-slate-800/50 border border-slate-700 rounded-lg animate-pulse"
                      />
                    ))
                  ) : (
                    <>
                ...
                <div className="space-y-4">
                  {projectsLoading && !projectsData ? (
                    Array.from({ length: 3 }).map((_, index) => (
                      <div
                        key={index}
                        className="p-4 bg-slate-700/30 rounded-lg animate-pulse h-20"
                      />
                    ))
