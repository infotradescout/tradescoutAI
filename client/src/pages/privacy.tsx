          ...
          <CardContent className="space-y-8">
            ...
            <section>
              ...
              <ul className="list-disc list-inside text-gray-300 space-y-2">
                ...
                <li>
                  Contact you for user experience surveys and platform improvement discussions
                  (TradeScout admin only)
                </li>
            ...
            <section>
              ...
              <div className="bg-green-500/20 border border-green-500/30 rounded-lg p-4 mb-6">
                ...
                <p className="text-green-100 font-medium">
                  TradeScout does NOT sell, distribute, or share your personal information with
                  third parties for marketing or commercial purposes. Your data stays with us.
                </p>
              </div>
              ...
              <ul className="list-disc list-inside text-gray-300 space-y-2">
                <li>
                  <strong>Contractor Matching:</strong> When you request quotes or services, we
                  share relevant contact information with contractors you choose to connect with
                </li>
                <li>
                  <strong>TradeScout Admin Contact:</strong> Our platform administrators may contact
                  you directly for user experience surveys, feedback sessions, or platform
                  improvement discussions
                </li>
                <li>
                  <strong>Essential Service Providers:</strong> With trusted partners who help
                  operate our platform (payment processing, security services) under strict data
              ...
              <div className="bg-orange-500/20 border border-orange-500/30 rounded-lg p-4 mt-4">
                <p className="text-orange-100 text-sm">
                  <strong>Important:</strong> When TradeScout administrators contact you for
                  feedback or surveys, these communications come directly from our team to improve
                  your experience. You can opt out of these communications at any time.
                </p>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="bg-blue-500/20 border border-blue-500/30 rounded-lg p-4 mt-4">
                <p className="text-blue-100 text-sm">
                  <strong>Communication Preferences:</strong> You can manage all communication
                  preferences in your account settings, including opting out of user experience
                  surveys and feedback requests from our team.
                </p>
              </div>
            </section>
            ...
            <section>
              ...
              <p className="text-gray-300">
                ...
                processors, and analytics providers. These services have their own privacy policies
            ...
            <section>
              ...
              <p className="text-gray-300">
                If you are accessing TradeScout from outside the United States, please be aware that
                your information may be transferred to and stored in the US. By using our service,
            ...
            <section>
              ...
              <p className="text-gray-300">
                ...
                changes via email or platform notification. Continued use of our service constitutes
            ...
            <section>
              ...
              <div className="text-gray-300 space-y-2">
                <p>
                  <strong>Privacy Questions:</strong> privacy@tradescout.com
                </p>
                <p>
                  <strong>General Support:</strong> support@tradescout.com
                </p>
                <p>
                  <strong>Mailing Address:</strong>
                </p>
                <p className="ml-4">
                  TradeScout Privacy Office
                  <br />
            ...
            <div className="bg-green-600/30 rounded-lg p-6 mt-8 border border-green-500/50">
              <h3 className="text-lg font-medium mb-3 text-green-200">
                🛡️ Data Protection Guarantee
              </h3>
              <div className="space-y-3 text-sm">
                <p className="text-green-100 font-medium">
                  <strong>Zero Third-Party Sales:</strong> We never sell, rent, or distribute your
                  personal information to outside companies, marketers, or data brokers.
                </p>
                <p className="text-green-100">
                  <strong>TradeScout Admin Contact Only:</strong> The only non-service
                  communications you'll receive from us are direct outreach from our team for user
                  experience feedback and platform improvements.
                </p>
                <p className="text-green-100">
                  <strong>Your Control:</strong> You can opt out of all admin communications while
                  still receiving essential service updates about your account.
                </p>
              </div>
            </div>

            <div className="bg-navy-700 rounded-lg p-6 mt-4">
              <h3 className="text-lg font-medium mb-3 text-orange-400">
                California Privacy Rights (CCPA)
              </h3>
              <p className="text-gray-300 text-sm">
                California residents have additional rights under the California Consumer Privacy
                Act. You may request to know what personal information we collect, delete your
                information, and opt out of the sale of personal information.{" "}
                <strong>Note: TradeScout does not sell personal information.</strong>
            ...
            <div className="bg-navy-700 rounded-lg p-6 mt-4">
              ...
              <p className="text-gray-300 text-sm">
                ...
                Regulation including data portability, erasure, and the right to object to
                processing. Contact our privacy team to exercise these rights.
              </p>
            </div>
          </CardContent>
        </Card>
