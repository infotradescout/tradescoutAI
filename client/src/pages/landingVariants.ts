...
const DEFAULT_VARIANT: LandingVariant = {
  ...
  headlineLines: ["Find the Right", "Local Help", "Without the Runaround"],
  subhead:
    "Tell Scout what you need, review focused local options, and open contact only when you're ready.",
