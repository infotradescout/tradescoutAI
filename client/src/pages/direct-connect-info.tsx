  ...
  const faqs = [
    {
      ...
      answer: "Direct Connect is TradeScout's matching system. When you request a contractor, Scout analyzes your job context (type, location, urgency, budget) and routes your request directly to 1-3 qualified, verified pros — not dozens of lead-buyers."
    },
    {
      question: "How is this different from Angi or HomeAdvisor?",
      answer: "Traditional platforms sell your request as a lead to many contractors who then compete in a bidding war. Direct Connect sends your request only to pre-matched, trust-verified contractors. No bidding wars, no lead spam."
    },
    {
      question: "Do contractors pay to receive my request?",
      answer: "No. Direct Connect matches are based on trust, relevance, and availability — not payment. Contractors pay TradeScout only when work is completed (transaction fee), not per lead."
    },
    {
      question: "What information does Scout send to contractors?",
      answer: "Scout includes: job type, location, timeline/urgency signals, budget range (if mentioned), special requirements, and your contact preference (call/message). Contractors can accept or decline before contacting you."
    },
    {
      question: "What if no contractors respond?",
      answer: "Scout will expand the search radius or suggest alternative trades. If still no match, you'll be asked if you want to post to the community for neighbor recommendations."
    }
  ];
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <header className="mb-12">
            ...
            <p className="text-xl text-tsTextSecondary">
              Trust-first contractor matching. No lead spam. No bidding wars. Just qualified professionals.
            </p>
          </header>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-tsTextSecondary mt-2">
                      Scout extracts: <strong>job type</strong> (roof repair), <strong>location</strong> (Austin), <strong>urgency</strong> (emergency), <strong>budget</strong> (~$2k).
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-tsSurface p-6 rounded-lg border border-tsBorder">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-tsTextSecondary mb-2">
                      Scout filters contractors by:
                    </p>
                    <ul className="list-disc list-inside space-y-1 text-tsTextSecondary ml-4">
                      <li><strong>Trust</strong>: CVS ≥ 60 (verified, licensed, insured)</li>
                      <li><strong>Trade match</strong>: Licensed for roofing</li>
                      <li><strong>Location</strong>: Serves Austin metro area</li>
                      <li><strong>Availability</strong>: Can respond to emergency within 24 hours</li>
                      <li><strong>Budget alignment</strong>: Typical pricing in your range</li>
                    </ul>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-tsSurface p-6 rounded-lg border border-tsBorder">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-tsTextSecondary">
                      Scout sends your request to <strong>1-3 qualified contractors</strong> (not 20+).
                    </p>
                    <p className="text-tsTextSecondary mt-2">
          ...
          <section className="mb-16">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="bg-tsSurface p-6 rounded-lg border border-tsBorder">
                ...
                <p className="text-tsTextSecondary">
                  Traditional platforms sell your request to 10-20+ contractors. You get bombarded with calls.
                </p>
                <p className="text-tsTextSecondary mt-2">
                  <strong>Direct Connect sends your request to 1-3 pre-matched pros.</strong> No spam.
                </p>
              </div>
              ...
              <div className="bg-tsSurface p-6 rounded-lg border border-tsBorder">
                ...
                <p className="text-tsTextSecondary">
                  On lead-buying platforms, contractors compete on price alone. You get lowball quotes that don't reflect reality.
                </p>
                <p className="text-tsTextSecondary mt-2">
                  <strong>Direct Connect matches on trust + relevance, not price competition.</strong>
                </p>
              </div>
              ...
              <div className="bg-tsSurface p-6 rounded-lg border border-tsBorder">
                ...
                <p className="text-tsTextSecondary">
                  Only contractors with CVS ≥ 60 (verified, licensed, insured) can receive Direct Connect requests.
                </p>
                <p className="text-tsTextSecondary mt-2">
              ...
              <div className="bg-tsSurface p-6 rounded-lg border border-tsBorder">
                ...
                <p className="text-tsTextSecondary">
                  Scout includes job details, urgency, and budget signals so contractors can accept or decline upfront.
                </p>
                <p className="text-tsTextSecondary mt-2">
            ...
            <div className="bg-tsSurface p-6 rounded-lg border border-tsBorder">
              <ul className="space-y-3 text-tsTextSecondary">
                <li className="flex items-start gap-2">
                  ...
                  <span><strong>No pay-per-lead</strong>: Contractors don't pay for every request (only completed work transaction fees)</span>
                </li>
                <li className="flex items-start gap-2">
                  <ArrowRight className="h-5 w-5 text-tsAccent shrink-0 mt-0.5" />
                  <span><strong>Qualified requests only</strong>: Scout filters out mismatches before routing</span>
                </li>
                <li className="flex items-start gap-2">
                  <ArrowRight className="h-5 w-5 text-tsAccent shrink-0 mt-0.5" />
                  <span><strong>Full context upfront</strong>: Job details, budget, urgency — no surprises</span>
                </li>
                <li className="flex items-start gap-2">
                  <ArrowRight className="h-5 w-5 text-tsAccent shrink-0 mt-0.5" />
                  <span><strong>Accept/decline before contact</strong>: No obligation to chase bad-fit leads</span>
                </li>
                <li className="flex items-start gap-2">
                  <ArrowRight className="h-5 w-5 text-tsAccent shrink-0 mt-0.5" />
                  <span><strong>Trust determines visibility</strong>: High CVS = more matches, regardless of ad spend</span>
                </li>
              </ul>
            </div>
          </section>
