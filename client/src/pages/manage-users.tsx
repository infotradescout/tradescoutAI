...
import { Users2, Search, Filter, Edit, Trash2, Shield, Crown, Eye, Ban, CheckCircle2, XCircle, MoreHorizontal, User } from 'lucide-react';
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-6 gap-4 mb-8">
          ...
          <Card className="bg-navy-800/50 border-navy-600 backdrop-blur-sm">
            <CardContent className="p-4 text-center">
              ...
              <div className="text-gray-400 text-sm">Contractors</div>
            </CardContent>
          </Card>
          ...
          <Card className="bg-navy-800/50 border-navy-600 backdrop-blur-sm">
            <CardContent className="p-4 text-center">
              ...
              <div className="text-gray-400 text-sm">Homeowners</div>
            </CardContent>
          </Card>
        </div>
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
          <TabsList className="bg-navy-800 border-navy-600">
            ...
            <TabsTrigger value="suspended" className="data-[state=active]:bg-orange-600">
                    ...
                    <div className="flex items-center gap-6">
                      <div className="text-right">
                        <div className="text-white font-medium">
                          {user.projects} {user.role === 'contractor_user' ? 'Projects' : 'Requests'}
                        </div>
                        {user.rating && (
