...
export default function TradeCityRecentPage() {
  ...
  const url = `/api/public/seo/recent/trade-city?tradeSlug=${encodeURIComponent(
    tradeSlug || ""
  ...
  const canonical = `https://www.thetradescout.com/trade/${encodeURIComponent(
    tradeSlug || ""
  )}/${encodeURIComponent((stateCode || "").toLowerCase())}/city/${encodeURIComponent(
    citySlug || ""
  )}/recent`;
