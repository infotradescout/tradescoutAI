  ...
  const sharingTemplates = [
    {
      ...
      template: 'Just completed an amazing {projectType} project in {location}! Check out the transformation on TradeScout: {link}',
      category: 'Project'
    },
    {
      id: 2,
      name: 'Service Promotion',
      template: 'Need {serviceType} in {location}? I\'m offering a special promotion this month! Book through TradeScout: {link}',
      category: 'Promotion'
    },
    {
      id: 3,
    ...
    },
    {
      ...
      template: 'Join us for {eventName} in {location} on {date}! Great opportunity to connect with local contractors and homeowners: {link}',
      category: 'Event'
    }
  ];
                      ...
                      <div className="space-y-3">
                        <div className="flex items-center gap-2">
                          ...
                          <Button 
                            size="sm" 
                            variant="outline"
                            onClick={() => copyToClipboard("https://tradescout.com/contractor/mike-construction-llc", "Profile Link")}
                          >
                            {copyStatus === "Profile Link" ? <Check className="h-4 w-4" /> : <Copy className="h-4 w-4" />}
                          </Button>
                        </div>
                      ...
                      <div className="space-y-3">
                        <div className="flex items-center gap-2">
                          ...
                          <Button 
                            size="sm" 
                            variant="outline"
                            onClick={() => copyToClipboard("https://tradescout.com/join?ref=MIKE2024", "Referral Link")}
                          >
                            {copyStatus === "Referral Link" ? <Check className="h-4 w-4" /> : <Copy className="h-4 w-4" />}
                          </Button>
                        </div>
                      ...
                      {[
                        ...
                        <div key={source.source} className="flex justify-between items-center p-3 bg-navy-700/50 rounded-lg">
                          ...
                          <div className="text-right">
                            ...
                            <div className="text-green-400 text-sm">{source.conversion} conversion</div>
                          </div>
                        </div>
                      ))}
                    </div>
