...
const howItWorks = [
  {
    ...
    description: "TradeScout will provide available campaign-branded item options.",
  },
  {
    title: "Choose the items that fit",
    description:
      "Supporters and sponsors can select practical branded items connected to the campaign.",
  },
  {
  ...
  return (
    <>
      <SEOHelmet
        ...
        description="A TradeScout-run campaign using branded items to support future trade school scholarships."
        canonical="https://www.thetradescout.com/trade-up-for-trade-schools"
      />

      <main className="min-h-screen overflow-x-hidden bg-[#f7f3ee] text-zinc-950">
        <header className="border-b border-zinc-200/80 bg-white">
          <div className="mx-auto flex max-w-6xl items-center justify-between gap-4 px-4 py-4 sm:px-6 lg:px-8">
            <Link href="/">
              <a className="inline-flex items-center gap-2 text-sm font-bold text-zinc-950">
                <span className="flex h-8 w-8 items-center justify-center rounded-md bg-zinc-950 text-ts-orange">
        ...
        <section className="bg-white">
          <div className="mx-auto grid max-w-6xl items-center gap-7 px-4 py-8 sm:px-6 sm:py-10 lg:grid-cols-[minmax(0,1fr)_420px] lg:px-8 lg:py-12">
            <div className="min-w-0">
              <div className="inline-flex max-w-full items-center rounded-full border border-orange-200 bg-orange-50 px-3 py-1 text-xs font-bold uppercase tracking-[0.12em] text-ts-orange">
                TradeScout-run campaign initiative
              </div>
              ...
              <p className="mt-4 max-w-2xl text-lg leading-8 text-zinc-700">
                A TradeScout-run campaign using branded items to support future trade school
                scholarships.
              </p>
              <div className="mt-5 flex flex-col gap-3 sm:flex-row sm:flex-wrap">
                <a
                  href="#campaign-items"
                  className="inline-flex min-h-11 items-center justify-center gap-2 rounded-md bg-ts-orange px-5 py-3 text-sm font-bold text-white hover:bg-ts-orange-dark"
                >
            ...
            <aside className="w-full min-w-0 rounded-lg border border-zinc-200 bg-[#fffaf4] p-5 shadow-sm">
              <div className="flex items-start gap-4">
                <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-md bg-ts-orange text-white">
                  <PenLine className="h-6 w-6" />
                </div>
                <div className="min-w-0">
                  <p className="text-xs font-bold uppercase tracking-[0.12em] text-ts-orange">
              ...
              <p className="mt-4 text-sm leading-6 text-zinc-700">
                Construction pencils, decals, sponsor cards, signage, and apparel connected to the
                Trade-Up For Trade Schools campaign.
              </p>
              <div className="mt-5 grid gap-2 sm:grid-cols-2">
                {previewItems.map((item) => (
                  <div
                    key={item}
                    className="rounded-md border border-orange-200 bg-white px-3 py-2 text-sm font-bold text-zinc-800"
                  >
                    {item}
                  </div>
                ))}
        ...
        >
          <div className="mb-6 max-w-3xl">
            <p className="text-sm font-bold uppercase tracking-[0.12em] text-ts-orange">
              Campaign Items
            </p>
            ...
            <p className="mt-3 text-base leading-7 text-zinc-700">
              Supporters, businesses, and sponsors can request Trade-Up For Trade Schools branded
              items connected to the campaign.
            </p>
          </div>
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {campaignItems.map((item) => {
              ...
              return (
                ...
                >
                  <div className="mb-4 flex h-10 w-10 items-center justify-center rounded-md bg-orange-50 text-ts-orange">
        ...
        <section className="border-y border-zinc-200 bg-white">
          <div className="mx-auto max-w-6xl px-4 py-8 sm:px-6 lg:px-8 lg:py-10">
            ...
            <p className="mt-5 rounded-lg border border-orange-200 bg-orange-50 px-4 py-3 text-sm font-bold text-zinc-800">
              Direct donation portal handled separately.
            </p>
          </div>
        </section>
        ...
        <section className="mx-auto grid max-w-6xl gap-6 px-4 py-8 sm:px-6 lg:grid-cols-[0.85fr_1.15fr] lg:px-8 lg:py-10">
          ...
          <div className="rounded-lg border border-zinc-200 bg-white p-5 shadow-sm">
            <p className="text-base leading-7 text-zinc-700">
              Businesses, crews, suppliers, shops, and community supporters can support the campaign
              by requesting branded items, sponsoring item runs, or helping distribute campaign
              materials.
            </p>
            <a
              href={contactHref}
              className="mt-5 inline-flex min-h-11 items-center justify-center gap-2 rounded-md bg-ts-orange px-5 py-3 text-sm font-bold text-white hover:bg-ts-orange-dark"
            >
              Sponsor the campaign
