  ...
  return (
    ...
    >
      ...
      <div
        ...
        className="scrollbar-hide flex max-w-full cursor-grab gap-3 overflow-x-auto overscroll-x-contain px-0 pb-5 [-ms-overflow-style:none] [-webkit-overflow-scrolling:touch] [scrollbar-width:none] active:cursor-grabbing sm:gap-4 sm:px-1 [&::-webkit-scrollbar]:hidden"
        role="list"
        onScroll={onScroll}
      >
        {stones.map((stone, index) => (
          <div
            ...
            className="min-w-[78%] flex-none sm:min-w-[56%] lg:min-w-[42%] xl:min-w-[34%]"
            role="listitem"
          >
            <StoneCard
              stone={stone}
