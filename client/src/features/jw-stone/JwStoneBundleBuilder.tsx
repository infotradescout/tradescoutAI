...
export function JwStoneBundleBuilder({
  ...
  return (
    ...
    >
      ...
      <button type="button" onClick={() => setPicking((current) => !current)}
        aria-expanded={picking} aria-controls="jw-bundle-stock-selection" data-testid="jw-bundle-open-picker"
        className="mt-3 min-h-11 w-full border border-[var(--jw-accent)] px-3 text-sm font-semibold">
        {picking ? "Done choosing slabs" : empty ? "Choose slabs for your bundle" : "Choose more slabs"}
      </button>
