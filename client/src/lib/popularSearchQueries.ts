...
export const BUSINESS_POPULAR_QUERIES: PopularQuery[] = [
  ...
  { query: "trade contractors", href: "/for-businesses" },
  { query: "commercial fencing", href: "/trade/fence-contractor" },
  { query: "commercial fence installation", href: "/trade/fence-contractor" },
  { query: "commercial cleaning services", href: "/trade/cleaning-services" },
  { query: "commercial electrical company", href: "/trade/electrical" },
  { query: "commercial hvac services", href: "/trade/hvac" },
  { query: "commercial plumbing", href: "/trade/plumbing" },
  { query: "commercial contractors", href: "/trade/general-contractor" },
