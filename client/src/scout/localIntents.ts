...
const QUICK_ACTION_NAV: Record<string, string> = {
  ...
  "open mealscout": "/mealscout",
  "open mealscout to browse local food and drink deals": "/mealscout",
  "open mealscout so i can manage or post deals for this": "/mealscout",
  "open mealscout to see my current deals and subscriptions": "/mealscout",
