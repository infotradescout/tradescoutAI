...
import { MapPin, ChevronDown, Sparkles, TrendingUp, Clock, Users, ShoppingBag, Wrench, Calendar } from "lucide-react";
  ...
  return (
    <div className="flex flex-col gap-4 w-full pb-2">
      ...
      <SectionLabel>
        ...
        {countyDisplay ? `Trending in ${snapshot?.countyName ?? location.county}` : "Try Asking Scout"}
      </SectionLabel>
      ...
      >
        ...
        <p className="text-[10px] leading-relaxed" style={{ color: "#444" }}>
          ...
          <span style={{ color: "#f97316" }}>Trade Scout Community</span>. Scout never charges
          for placement or ranking.
        </p>
      </div>
    </div>
  );
