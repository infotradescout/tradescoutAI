...
function getTradeIcon(trade: TradeCategory) {
  ...
  if (TRADE_CATEGORIES.general_small_business.includes(trade as any)) {
...
function getTradeColor(trade: TradeCategory): string {
  ...
  // General & Retail Small Business - Teal
  if (TRADE_CATEGORIES.general_small_business.includes(trade as any)) {
...
export function TradeCategoryHeader({ category, trades }: TradeCategoryHeaderProps) {
  const categoryNames = {
    ...
    general_small_business: "General & Retail Small Business",
  };
  ...
  const categoryIcons = {
    ...
    general_small_business: <Store className="h-4 w-4" />,
  };
