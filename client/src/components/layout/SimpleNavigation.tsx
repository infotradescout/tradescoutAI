      ...
      <div className="container mx-auto px-6">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden lg:flex items-center space-x-6">
            <Link href="/find-contractors" className="group relative px-3 py-2 text-gray-300 hover:text-white transition-all duration-300">
            ...
            <div className="relative group">
              ...
              <div className="absolute top-full left-0 mt-2 w-56 bg-slate-800 border border-slate-700 rounded-xl shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 z-50">
                <div className="py-2">
                  <Link href="/worker-marketplace" className="block px-4 py-3 text-gray-300 hover:text-white hover:bg-slate-700/50 transition-colors">
                    <div className="font-medium">Helpers & Workers</div>
                    <div className="text-sm text-gray-400">Find skilled helpers for projects</div>
                  </Link>
                  <Link href="/vehicle-marketplace" className="block px-4 py-3 text-gray-300 hover:text-white hover:bg-slate-700/50 transition-colors">
                    <div className="font-medium">Vehicle Sales</div>
                    <div className="text-sm text-gray-400">Buy & sell cars, trucks, equipment</div>
                  </Link>
                  <Link href="/real-estate-marketplace" className="block px-4 py-3 text-gray-300 hover:text-white hover:bg-slate-700/50 transition-colors">
                    <div className="font-medium">Real Estate</div>
                    <div className="text-sm text-gray-400">Properties, homes, land listings</div>
                  </Link>
                  <Link href="/handmade-marketplace" className="block px-4 py-3 text-gray-300 hover:text-white hover:bg-slate-700/50 transition-colors">
            ...
            <Link href="/daily-deals" className="group relative px-3 py-2 text-gray-300 hover:text-white transition-all duration-300">
              <span className="relative z-10 font-medium">Deals</span>
              <div className="absolute inset-0 bg-white/5 rounded-lg opacity-0 group-hover:opacity-100 transition-all duration-300"></div>
              <div className="absolute bottom-0 left-1/2 w-0 h-0.5 bg-gradient-to-r from-orange-500 to-orange-600 group-hover:w-full group-hover:left-0 transition-all duration-300"></div>
            </Link>
            <Link href="/groups" className="group relative px-3 py-2 text-gray-300 hover:text-white transition-all duration-300">
              <span className="relative z-10 font-medium">Groups</span>
              <div className="absolute inset-0 bg-white/5 rounded-lg opacity-0 group-hover:opacity-100 transition-all duration-300"></div>
              <div className="absolute bottom-0 left-1/2 w-0 h-0.5 bg-gradient-to-r from-orange-500 to-orange-600 group-hover:w-full group-hover:left-0 transition-all duration-300"></div>
            </Link>
            <Link href="/county-hub" className="group relative px-3 py-2 text-gray-300 hover:text-white transition-all duration-300">
              <span className="relative z-10 font-medium">Community</span>
              <div className="absolute inset-0 bg-white/5 rounded-lg opacity-0 group-hover:opacity-100 transition-all duration-300"></div>
              <div className="absolute bottom-0 left-1/2 w-0 h-0.5 bg-gradient-to-r from-orange-500 to-orange-600 group-hover:w-full group-hover:left-0 transition-all duration-300"></div>
            </Link>
            
            {/* Premium CTAs / User Menu */}
            <div className="flex items-center space-x-4 ml-8 pl-8 border-l border-white/10">
              {isAuthenticated ? (
                <>
                  {/* Dashboard Link */}
                  <Link href="/dashboard" className="group relative px-3 py-2 text-gray-300 hover:text-white transition-all duration-300">
                  ...
                  {/* Notifications Link */}
                  <Link href="/notifications" className="group relative px-3 py-2 text-gray-300 hover:text-white transition-all duration-300">
                    <span className="relative z-10 font-medium flex items-center gap-2">
                  ...
                  <div className="relative group">
                    <button className="group relative px-3 py-2 text-gray-300 hover:text-white transition-all duration-300 flex items-center gap-2">
                      ...
                      <span className="relative z-10 font-medium">{user?.firstName || 'Account'}</span>
                      <svg className="w-4 h-4 transition-transform group-hover:rotate-180" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                      </svg>
                      <div className="absolute inset-0 bg-white/5 rounded-lg opacity-0 group-hover:opacity-100 transition-all duration-300"></div>
                    ...
                    {/* User Dropdown Menu */}
                    <div className="absolute top-full right-0 mt-2 w-56 bg-slate-800 border border-slate-700 rounded-xl shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 z-50">
                      <div className="py-2">
                        <div className="px-4 py-2 border-b border-slate-700">
                          <div className="text-sm font-medium text-white">{user?.firstName} {user?.lastName}</div>
                          <div className="text-xs text-gray-400">{user?.email}</div>
                        </div>
                        <Link href="/profile" className="block px-4 py-3 text-gray-300 hover:text-white hover:bg-slate-700/50 transition-colors">
                          <div className="font-medium flex items-center gap-2">
                            <User className="w-4 h-4" />
                            Profile
                          </div>
                        </Link>
                        <Link href="/settings" className="block px-4 py-3 text-gray-300 hover:text-white hover:bg-slate-700/50 transition-colors">
                          <div className="font-medium">Settings</div>
                        </Link>
                        <button 
                          onClick={logout}
                          className="w-full text-left px-4 py-3 text-gray-300 hover:text-white hover:bg-slate-700/50 transition-colors border-t border-slate-700"
                        >
                          <div className="font-medium flex items-center gap-2">
