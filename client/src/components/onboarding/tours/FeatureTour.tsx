      ...
      return [
        {
          ...
          description: "Help other homeowners by sharing your experience with this contractor. Your feedback builds trust in the community.",
          position: "top"
        },
        {
          id: "thumbs-system",
          ...
          description: "Simple but powerful - give a thumbs up for good work or thumbs down if you had issues. This directly affects contractor rankings.",
          position: "bottom"
        },
        {
          id: "add-details",
          ...
          title: "Share Details",
          description: "Add specific details about the work quality, timeliness, and professionalism. This helps other homeowners make informed decisions.",
          position: "bottom"
        }
      ];
      ...
      return [
        {
          ...
          description: "Find exactly the right contractor for your project using our advanced search and filtering system.",
          position: "bottom"
        },
        {
          id: "location-filter",
        ...
        },
        {
          ...
          description: "Narrow down to contractors who specialize in exactly what you need - from plumbing to roofing to electrical work.",
          position: "bottom"
        },
        {
          id: "sorting-options",
          ...
          title: "Sort Results",
          description: "Sort by recommendations, ratings, or experience. Contractors with more positive feedback appear higher in results.",
          position: "left"
        }
      ];
