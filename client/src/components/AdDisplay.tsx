    ...
    >
      <CardContent className="p-4 relative">
        <Button
          variant="ghost"
          size="sm"
          className="absolute top-2 right-2 h-6 w-6 p-0 text-white/60 hover:text-white/60"
        ...
        <div className="pr-8">
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <Button
              ...
              variant="outline"
              size="sm"
              className="text-sm border-white/10 text-white/60 hover:bg-white/5 dark:border-white/15 dark:text-white/70 dark:hover:bg-white/5"
