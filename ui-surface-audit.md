...
- • `client/src/pages/profile-sites/WholesalerProfileTheme.tsx` — bg-* (114) @ lines 771,803,806,825,833 | gradient (3) @ lines 1883,1883,1883
...
- • `client/src/pages/profile-sites/PremiumProductProfileSections.tsx` — bg-* (38) @ lines 91,94,136,146,156 | gradient (16) @ lines 146,146,146,146,213
