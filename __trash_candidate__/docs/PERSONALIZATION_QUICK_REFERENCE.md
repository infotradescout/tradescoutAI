...
- Marketplace language: avoid explicit "investment" or "asset" terminology; let value-building show through quality, reputation, and outcomes instead of financial framing.
- Lead generation phrasing: avoid "lead/leads" in user-facing copy; prefer "projects", "opportunities", "requests", or "connections" when describing how Scout helps contractors find work.
