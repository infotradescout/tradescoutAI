...
import { hasPrivilegedVerificationBypass } from "./privilegedVerification";
 ...
 */
const REQUIREMENT_EXPLANATIONS: Record<
  string,
  {
    label: string;
    why: string;
 ...
 */
function getVerificationPath(requirements: string[], context: VerificationGateContext): string {
