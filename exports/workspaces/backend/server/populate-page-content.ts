      ...
      .values([
        {
          ...
          content:
            "Looking for recommendations for a reliable roofing contractor in the LA area. Need someone experienced with tile roofs. Had some storm damage recently and need quality work.",
          authorId: userId,
        ...
        },
        {
          ...
          content:
            "Just wanted to share my experience with Sunshine Electrical Services. They did an incredible job upgrading my electrical panel and installing smart home features. Highly recommend!",
          authorId: userId,
          category: "recommendations",
          scope: "county",
          stateCode: "CA",
        ...
        },
        {
          ...
          content:
            "Join us for a free workshop on basic home maintenance! Learn simple repairs, seasonal prep, and when to call professionals. Saturday 2PM at the community center.",
          authorId: userId,
          category: "events",
          scope: "county",
          stateCode: "CA",
      ...
      .values([
        {
          ...
          description:
            "Our beloved community center was severely damaged in recent storms. Help us rebuild this vital hub where families gather, children learn, and neighbors connect. Every donation brings us closer to reopening our doors.",
        ...
        },
        {
          ...
          description:
            "Critical repairs needed for veteran emergency shelter roof and plumbing systems. Over 100 veterans depend on this facility for safe housing while they rebuild their lives.",
          category: "veterans",
          countyId: "orange",
        ...
        },
        {
          ...
          description:
            "Building raised garden beds and greenhouse for elementary school. Students will learn about nutrition, sustainability, and responsibility while growing fresh produce for the cafeteria.",
          category: "education",
          countyId: "riverside",
    ...
    const tasksToInsert = [
      {
        ...
        description:
          "Need help organizing and cleaning out a cluttered 2-car garage. Some heavy lifting required.",
        categoryId: "cleaning",
        taskType: "one_time",
        estimatedHours: 6,
        payType: "fixed",
      ...
      },
      {
        ...
        description:
          "Weekly lawn maintenance needed for medium-sized front and back yard. Own equipment preferred.",
