...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-[13px] font-semibold ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ts-orange focus-visible:border-ts-orange focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 active:translate-y-px [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
          "bg-ts-orange text-black hover:bg-ts-orange-dark shadow-[0_14px_30px_-18px_rgba(249,115,22,0.95)] hover:shadow-[0_18px_36px_-18px_rgba(249,115,22,1)]",
        destructive: "bg-red-500 text-white hover:bg-red-500/90",
        outline: "border border-white/15 bg-white/5 text-white hover:bg-white/10 hover:text-white",
        secondary:
