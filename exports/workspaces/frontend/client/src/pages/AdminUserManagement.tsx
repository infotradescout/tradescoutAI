...
export default function AdminUserManagement() {
  ...
  if (!isAuthenticated || !user || !isAdminTier(user.role)) {
    return (
    ...
    <div className="container mx-auto px-4 py-8 space-y-8">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <div className="px-3 py-1 bg-gradient-to-r from-purple-500 to-pink-500 text-white rounded-full text-sm font-medium">
            {isSuperAdminLike(user.role) ? "Super Admin" : "Admin"}
          </div>
        </div>
      </div>
          ...
          <div className="lg:col-span-2">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  You have multiple roles assigned. Use the role switcher to access different
                  platform features and dashboards seamlessly.
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="grid grid-cols-2 gap-4 text-sm">
                  ...
                  <div>
                    ...
                    <div className="text-muted-foreground">
                      {user.roles?.length || 1} roles assigned
                    </div>
                  </div>
                </div>
              </CardContent>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Available tools and capabilities for user management</CardDescription>
        </CardHeader>
        <CardContent>
