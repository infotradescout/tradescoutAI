...
export const USER_TYPES: Record<string, UserTypeMetadata> = {
  ...
  other: {
    ...
    label: "Other (specify)",
    description:
      "Custom role entered by the user; we will add a dedicated badge if enough users share it",
    icon: "Tag",
    category: "platform",
  ...
  restaurant_owner: {
    ...
    description:
      "Restaurant, cafe, or hospitality business owner managing vendors and local services",
    icon: "UtensilsCrossed",
    category: "business",
    defaultView: "business",
    features: ["commercial_services", "business_profile", "marketplace"],
  },
  food_truck_owner: {
    id: "food_truck_owner",
    label: "Food Truck Owner",
    description: "Mobile vendor managing operations, equipment, and local services",
    icon: "Truck",
    category: "business",
    defaultView: "business",
    features: ["business_profile", "marketplace", "route_optimization"],
  },
  bar_owner: {
    id: "bar_owner",
    label: "Bar / Lounge Owner",
    description: "Bar, lounge, or nightlife venue managing vendors and local services",
    icon: "Wine",
    category: "business",
    defaultView: "business",
    features: ["business_profile", "marketplace", "event_management"],
  },
  commercial_property: {
