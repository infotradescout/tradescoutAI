...
export const SELL_CATEGORY_FLOWS: Record<ExchangeCategorySlug, SellCategoryFlow> = {
  ...
  "building-materials": {
    ...
    why: "Best for materials that need availability, project fit, and quote review without duplicating a full business catalog or inventing a public price.",
    checklist: [
    ...
    descriptionPrompt:
      "Describe the supported material families and direct buyers to the maintained business profile for current availability and a managed quote.",
