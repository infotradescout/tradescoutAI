...
Owner: TradeScout platform. Rationale: dual-write attribution observations and
...
This adapter does not send or apply profile inheritance. TradeScout's existing
account-to-business-to-profile inheritance remains TradeScout-owned behavior
with its existing human confirmation gates.
