...
Owner: TradeScout platform. Rationale: dual-write observations while local
affiliate attribution remains authoritative. Review/remove the exception after
parity evidence is accepted; target review date: 2026-10-18.
