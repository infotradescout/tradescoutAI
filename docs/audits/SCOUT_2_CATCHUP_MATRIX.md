...
2. Continue replacing legacy `/contractors/:slug` links in recommendation directories and older SEO helpers once those API payloads expose canonical business profile URLs.
