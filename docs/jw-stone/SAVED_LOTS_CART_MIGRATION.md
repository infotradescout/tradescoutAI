...
Historical branch record. See [Receiving integration release](RECEIVING_INTEGRATION_RELEASE.md) for the current production-cart-compatible migration and acceptance requirements.
