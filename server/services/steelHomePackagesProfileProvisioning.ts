  ...
  await db.transaction(async (tx) => {
    ...
    const businessValues = {
      ...
      profileData: {
        ...
        category: "Steel-home project center",
        services: [
          "Steel building and roof planning",
          "Photographed stone selection and countertop planning",
          "Cabinet layout and budget planning",
          "Whole-home scope and local project review",
        ],
