...
type VerificationDatabase = NodePgDatabase<typeof import("@shared/schema")>;
type VerificationTransaction = Parameters<Parameters<VerificationDatabase["transaction"]>[0]>[0];
