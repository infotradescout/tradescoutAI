 ...
 * This should ONLY be called from admin routes.
 */
export function approveBlueprint(proposalId: number, adminUserId: number, notes?: string) {
 ...
 * This should ONLY be called from admin routes.
 */
export function rejectBlueprint(proposalId: number, adminUserId: number, reason?: string) {
 ...
 * This should ONLY be called from admin routes.
 */
export function deferBlueprint(proposalId: number, adminUserId: number, notes?: string) {
