...
const INTENT_PROMPTS: Record<string, { text: string; category: string; icon: string }> = {
  marketplace: {
    text: "Listings and pricing in my local marketplace",
    category: "Saved search flow",
    icon: "🛋",
  },
  contractor: {
    text: "Recent home project momentum in this area",
    category: "Home project flow",
    icon: "🔨",
  },
  permit: {
    text: "Pending local service request",
  ...
  gas: {
    text: "Vehicle service trend around me",
    category: "Vehicle flow",
    icon: "⛽",
  },
  events: {
    text: "Community activity in this area",
    category: "Community flow",
    icon: "🎉",
  },
  food: {
    text: "Local people and request activity",
    category: "Community flow",
    icon: "🌮",
  },
  hoa: {
    text: "Neighbor activity in nearby homes",
    category: "Community flow",
    icon: "🏘",
  },
  realtor: {
    text: "Home listing movement near me",
    category: "Homes flow",
    icon: "🏠",
  },
  employment: {
    text: "Project activity and local work openings",
    category: "Project flow",
    icon: "💼",
  },
  unknown: {
    text: "Continue local scout flow",
    category: "General flow",
    icon: "✨",
  },
};
