...
export async function registerRoutes(app: any) {
  ...
  const userHasProtectedAdminRole = isProtectedAdminUser;
  const userIsSuperAdmin = isSuperAdminUser;
...
<p>After you sign in, you can finish your profile and complete insurance/license verification.</p>`,
  ...
  registerPaymentWebhookRoutes(app, {
    stripeProvider: getStripeClient,
    webhookSecretProvider: () => process.env.STRIPE_WEBHOOK_SECRET,
    paymentService,
