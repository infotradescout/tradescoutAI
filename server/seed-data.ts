...
export async function seedDatabase() {
  try {
    ...
    const seededContractors = [
      {
        ...
        about:
          "Premier roofing contractor serving Los Angeles County for over 15 years. Specializing in residential and commercial roof repairs, replacements, and maintenance.",
        serviceRadius: 50,
        isActive: true,
        isVerified: true,
        avgRating: 4.8,
      ...
      },
      {
        ...
        about:
          "Full-service plumbing company covering Orange and Los Angeles counties. Emergency repairs, installations, and maintenance for residential and commercial properties.",
        serviceRadius: 40,
        isActive: true,
        isVerified: true,
        avgRating: 4.9,
      ...
      },
      {
        ...
        about:
          "Licensed electricians providing safe, reliable electrical services throughout Southern California. Specializing in panel upgrades, wiring, and smart home installations.",
        serviceRadius: 60,
        isActive: true,
        isVerified: true,
        avgRating: 4.7,
      ...
      },
      {
        ...
        about:
          "HVAC installation, repair, and maintenance specialists. Energy-efficient solutions for homes and businesses across Los Angeles and surrounding areas.",
        serviceRadius: 45,
        isActive: true,
        isVerified: true,
        avgRating: 4.6,
      ...
      },
      {
        ...
        about:
          "High-quality interior and exterior painting services. Using premium materials and expert craftsmanship to transform homes and businesses.",
        serviceRadius: 35,
        isActive: true,
        isVerified: true,
        avgRating: 4.5,
      ...
      },
      {
        ...
        about:
          "Full-service general contractors specializing in kitchen and bathroom remodels, home additions, and custom construction projects.",
        serviceRadius: 50,
        isActive: true,
        isVerified: true,
        avgRating: 4.9,
    ...
    await db.insert(contractors).values(seededContractors).onConflictDoNothing();
